...
class Settings(BaseSettings):
    ...
    use_langsmith_prompts: bool = True # Flag to use Langsmith prompts
    local_prompts_dir: str = "src/application/prompts/" # Path to local prompt templates directory
    langchain_api_key: str # Langchain API key

    # Prompts
    prompt_name_chit_chat: str # Name of the prompt for detecting Chit-Chat exchanges
    prompt_name_filters_detection: str # Name of the prompt for filter detection from user request
    prompt_name_filters_value_extraction: str # Name of the prompt for filter value extraction
    prompt_name_language_detector: str # Name of the prompt for language detection
    prompt_name_question_summarizer: str # Name of the prompt for user question summarization
    prompt_name_search_summary: str # Name of the prompt for search summary
    prompt_name_search_term_extraction: str # Name of the prompt for search summary
    prompt_name_summary_exchange: str # Name of the prompt for message history summarization
