...
class SearchResponseBuilderLotOneFilterStrategyAgent(SearchResponseBuilderStrategyAgent):
    ...
    def apply(self, context:SearchContext):
        ...
        return nb_product_found > 5 and nb_detected_filters > 0 and nb_used_filters == 1
