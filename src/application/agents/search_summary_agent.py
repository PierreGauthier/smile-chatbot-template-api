...
class SearchSummaryAgent:
    ...
    def invoke(self, context: SearchContext) -> str:
        ...
        question = f"Provide a short summary of a search for {context.detected_attribute_set.term} with filters: {filters_summary} that will complete naturaly your last reponse: {context.ai_answer}"
