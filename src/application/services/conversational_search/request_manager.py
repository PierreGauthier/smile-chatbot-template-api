...
class RequestManager:
    ...
    def build_requests(self, context:SearchContext) -> SearchContext:
        ...
        product =  context.detected_attribute_set.product
        term = context.detected_attribute_set.term
        ...
        if attribute_set:
            ...
            detected_filters = self.filters_extraction_agent.invoke(context=context)
