...
class CosmosDBChatMessageHistory(BaseChatMessageHistory):
    ...
    def prepare_cosmos(self) -> None:
        ...
        database = self._client.get_database_client(self.cosmos_database)
    ...
    def add_message(self, message: BaseMessage) -> None:
        ...
        message.additional_kwargs["datetime"] = datetime.datetime.now().isoformat()
