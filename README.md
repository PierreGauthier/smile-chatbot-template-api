...
<a href="https://github.com/alrey-smile/smile-chatbot-template-api/actions/workflows/deploy.yml">
   <img src="https://github.com/alrey-smile/smile-chatbot-template-api/actions/workflows/deploy.yml/badge.svg?branch=staging" height="20" alt="GitHub Actions Status">
</a>
...
- [`docs/deployment.md`](docs/deployment.md): Azure deployment checklist and operational tips.
